        ...
        <div className="container pr-4 md:pr-8 relative z-10">
          ...
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a
                href="#booking"
                className="inline-flex items-center gap-2 rounded-full bg-primary text-primary-foreground hover:opacity-90 px-6 py-3 text-sm font-bold text-emerald-950 transition-transform hover:scale-105"
              >
                احجز مقعدك الآن
                <ChevronLeft size={18} />
              </a>
        ...
        <div className="container pr-4 md:pr-8">
          ...
          <div className="text-center mt-8">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-sm font-bold text-white transition-transform hover:scale-105 shadow-lg shadow-emerald-200"
            >
          ...
          <div className="max-w-3xl mx-auto bg-ivory rounded-2xl shadow-soft p-6 md:p-8 border border-primary/20">
            <div className="space-y-6">
              ...
              <button
                ...
                className="w-full rounded-full bg-gradient-to-l from-primary to-primary/80 py-3.5 text-sm font-bold text-white shadow-lg shadow-emerald-200 transition-transform hover:scale-[1.02]"
              >
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-bold text-primary shadow-lg transition-transform hover:scale-105"
              >
