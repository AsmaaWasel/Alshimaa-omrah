...
• ملاحظات: ${notes || "لا يوجد"}`;
  ...
  return (
    <div className="min-h-screen bg-ivory">
      ...
      <section className="relative overflow-hidden py-16 md:py-24 bg-gradient-to-br from-amber-900 via-amber-800 to-amber-950">
        ...
        <div className="container pr-4 md:pr-8 relative z-10">
          ...
          <div className="max-w-3xl">
            <span className="inline-block rounded-full bg-amber-500/30 px-4 py-1.5 text-xs font-semibold text-amber-200 mb-5">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-amber-300 mt-3">
              فخامة في كل تفصيلة
            </h2>
            <p className="mt-5 text-amber-100/80 text-base md:text-lg max-w-xl leading-relaxed">
      ...
      <section className="py-14 md:py-20">
        <div className="container pr-4 md:pr-8">
          ...
          <div className="grid gap-5 md:gap-6 md:grid-cols-2 lg:grid-cols-4 items-stretch">
            <div className="flex flex-col rounded-2xl bg-white p-6 shadow-soft border border-amber-100">
            ...
            {vipFeatures.map((feature, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="flex flex-col rounded-2xl border border-amber-100 bg-gradient-to-br from-white to-amber-50/30 p-6 shadow-soft hover:shadow-lg transition-shadow"
                >
      ...
      <section className="py-14 md:py-20">
        <div className="container pr-4 md:pr-8">
          <div className="grid gap-6 md:gap-8 md:grid-cols-2 items-stretch">
            <div className="flex flex-col rounded-2xl bg-white p-6 md:p-8 shadow-soft border border-amber-100">
            ...
            <div className="flex flex-col rounded-2xl bg-white p-6 md:p-8 shadow-soft border border-amber-100">
              ...
              <ul className="space-y-3.5">
                ...
                <li className="flex items-start gap-3 bg-amber-50 rounded-xl p-3.5">
      ...
      <section id="booking" className="py-14 md:py-20 bg-white">
        <div className="container pr-4 md:pr-8">
          <div className="text-center mb-10">
            <div className="inline-block rounded-full bg-amber-100 px-4 py-1.5 text-xs font-semibold text-amber-700 mb-4">
          ...
          {/* Features Bar */}
          <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-3 rounded-2xl bg-amber-50/50 p-5 mb-10 max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-3 md:grid-cols-3">
                ...
                >
                  ...
                  <p className="text-xs font-bold mt-1.5">اقتصادية</p>
                ...
                >
                  ...
                  <p className="text-xs font-bold mt-1.5 text-amber-700">VIP</p>
                ...
                >
                  ...
                  <p className="text-xs font-bold mt-1.5">باص فقط</p>
      ...
      {/* CTA Section */}
      <section className="py-14 md:py-20 bg-gradient-to-l from-amber-500 to-amber-600">
        <div className="container pr-4 md:pr-8 text-center">
          <div className="max-w-2xl mx-auto">
            <Crown size={48} className="mx-auto text-white/80 mb-5" />
